...
if($_POST){
    if($_POST['aksi']=='tambah'){  // Untuk Manajemen
        ...
        // Ubah Status Verifikasi Pembayaran (Jika yang membayar adalah petugas maka status sudah verifikasi namun jika yang membayar adalah siswa/ortu siswa maka status belum verifikasi)
...
if($_GET){
    if($_GET['aksi']=='hapus'){
        ...
        // $sql_start=mysqli_query($koneksi,"START TRANSACTION");       
        ...
        // $sql_finish=mysqli_query($koneksi,"START TRANSACTION");
        // $sql_finish=mysqli_query($koneksi,"START TRANSACTION");
